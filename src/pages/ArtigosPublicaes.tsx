...
const ArtigosPublicaes: FunctionComponent = () => {
  ...
  const onCc2fbcF9a9416aA0d46c0a2de6ImageClick = useCallback(() => {
    window.open("https://medium.com/@jrsantiagojr");
  }, []);
  ...
  return (
    <div className={styles.artigosPublicaes}>
      ...
      />
      <div className={styles.cc2fbcF9a9416aA0d46c0a2de6Wrapper}>
        <img
          className={styles.cc2fbcF9a9416aA0d46c0a2de6Icon}
          alt=""
          src="/35cc2fbcf9a9416aa0d46c0a2de69d83-5@2x.png"
          onClick={onCc2fbcF9a9416aA0d46c0a2de6ImageClick}
        />
      </div>
      <img
        className={styles.carbonarrowUpIcon}
        alt=""
        src="/carbonarrowup1.svg"
